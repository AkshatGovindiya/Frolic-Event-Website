...
export default function Event() {
  ...
  const url = 'http://localhost:1678/event';
  ...
  const filteredEvents = selectCategory?event.filter((data)=>data.Category==selectCategory):event;

  var printData = filteredEvents.map((data)=>{
    return(
      <>
        ...
        <div className="col-md-4 mb-4">
          ...
          <div className="m-3">
            <h1 id="eventTitle" className="text-white">{data.Title}</h1>
            <h5 className="text-white">{data.Description}</h5>
            <Link to="/registrationpage/"><button id="register-btn" >Register Now</button></Link>
          </div>
        </div>
      </>
    ) 
  ...
  return (
    ...
    <div className="text-center mt-4 mb-4">
      ...
      <div className="text-white" id="event">
        <ul className="d-flex justify-content-evenly">
        <li onClick={() => setSelectedCategory("General")}>
        ...
        <li onClick={() => setSelectedCategory("Computer")}>
          ...
          <li onClick={() => setSelectedCategory("Management")}>
          ...
          <li onClick={() => setSelectedCategory("Mechanical")}>
          ...
          <li onClick={() => setSelectedCategory("Civil")}>
          ...
          <li onClick={() => setSelectedCategory("Electrical")}>
